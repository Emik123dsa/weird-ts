...
export class SetDepartmentsInfoFields implements Action {
  ...
  constructor(public payload: DepartmentSetterModel) { }
}
/**
...
export class SetDepartmentsContactPersonsFields implements Action {
  public readonly type = EnumDepartmentActions.SetDepartmentsContactPersonsFields;
  constructor(public payload: DepartmentSetterModel) { }
}
/**
...
export class SetDepartmentContactPersonsFields implements Action {
  public readonly type = EnumDepartmentActions.SetDepartmentContactPersonsFields;
  constructor(public payload: DepartmentSetterModel) { }
}
...
export class SetDepartmentsInfoFieldsSuccess implements Action {
  public readonly type = EnumDepartmentActions.SetDepartmentsInfoFieldsSuccess;
  constructor(public payload: DepartmentSetterModel) { }
}
/**
 * Info fields for department change
...
export class SetDepartmentsContactPersonsFieldsSuccess implements Action {
  public readonly type = EnumDepartmentActions.SetDepartmentsContactPersonsFieldsSuccess;
  constructor(public payload: DepartmentSetterModel) { }
}
/**
 * Cotnact persons fields for department change
...
export class SetDepartmentContactPersonsFieldsSuccess implements Action {
  public readonly type = EnumDepartmentActions.SetDepartmentContactPersonsFieldsSuccess;
  constructor(public payload: DepartmentSetterModel) { }
}

export type DepartmentActions =
  GetDepartment | GetDepartments
  | GetDepartmentSuccess | GetDepartmentsSuccess
  | SetDepartmentContactPersonsFields | SetDepartmentContactPersonsFieldsSuccess
  | SetDepartmentsContactPersonsFields | SetDepartmentsContactPersonsFieldsSuccess
  | SetDepartmentInfoFields | SetDepartmentInfoFieldsSuccess
  | SetDepartmentsInfoFields | SetDepartmentsInfoFieldsSuccess;
